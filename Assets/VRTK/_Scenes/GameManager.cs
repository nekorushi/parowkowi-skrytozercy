...
public class GameManager : MonoBehaviour {
	...
	public GameObject resetLevelButtons;
	...
	void Start () {
		...
		if (resetLevelButtons)
			resetLevelButtons.SetActive (false);
	}
	...
	void EndGame() {
		...
		if (resetLevelButtons)
			resetLevelButtons.SetActive (true);
	...
	{
		Application.LoadLevel (resetLevelToLoad);
	}
}
